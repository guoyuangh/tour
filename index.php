...
<div class="page_header">
  <div class="container center-block clearfix">
    ...
    <ul class="page_menu nav nav-pills fl">
      ...
      <li><a href="list.php" target="_blank">赛事门票</a></li>
      <li><a>五大联赛</a></li>
      <li><a>赛事旅行</a></li>
      <li><a>体育资讯</a></li>
    </ul>
...
?>
          <div class="col-md-6">
            <div class="game_item game_item_lg">
              <div class="game_img"><a target="_blank" href="detail.php?aid=<?php echo $new_list[0]['id']?>"><img src="<?php echo $v['litpic']?>" /></a></div>
	...
	$.ajax({
	   ...
	   success: function(msg){
			...
			{  
				...
				if(j <= 7){
				    list1 += '<td><div class="game_img"><img src="'+json[i].litpic+'" /></div><a class="game_name" target="_blank" href="detail.php?aid='+json[i].aid+'">'+json[i].spotname+'</a></td>';
				};
				if(j > 7 && j<=14){
				    list2 += '<td><div class="game_img"><img src="'+json[i].litpic+'" /></div><a class="game_name" target="_blank" href="detail.php?aid='+json[i].aid+'">'+json[i].spotname+'</a></td>';
				};
				if(j > 14 && j<=21){
				    list3 += '<td><a class="game_name" target="_blank" href="detail.php?aid='+json[i].aid+'">'+json[i].spotname+'</a></td>';
				};
				if(j > 21 && j<=28){
				    list4 += '<td><a class="game_name" target="_blank" href="detail.php?aid='+json[i].aid+'">'+json[i].spotname+'</a></td>';
				};
